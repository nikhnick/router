            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <ul className="text-gray-500 font-medium">
                                ...
                                <li className='mb-4'>
                                    <NavLink to="/user/nikhnick"  className={({isActive}) => `hover:underline ${isActive ? "text-orange-700" : "text-gray-700"}`}>
                                        User
                                    </NavLink>
                                </li>
                                <li>
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 font-medium">
                                <li className="mb-4">
                                    <a
                                        href="https://github.com/nikhnick"
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center">
                        &copy; 2023 <a href="https://github.com/nikhnick" target="_blank" className="hover:underline">Nikhil Hedukar</a>
                        . All Rights Reserved.
                    </span>
